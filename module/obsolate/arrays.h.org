...
// Include Mike Reid's quicksort template
#include "quicksort.h"
#include "sstring.h"
...
void Vector<Type>::sort(void)
  ...
  /* Sort in ascending order. The current buffer is replaced by a
     buffer with all elements sorted. */
{
...
typedef Vector<VectorD> VectorVectorD;
